...
var map_ServiceSpec = map[string]string{
	...
	"type":            "Type of exposed service. Must be ClusterIP, NodePort, LoadBalancer, or Private. Defaults to ClusterIP. More info: http://releases.k8s.io/HEAD/docs/user-guide/services.md#external-services",
