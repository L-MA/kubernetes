		...
		if false {
			...
			if yyr1493 || yy2arr1493 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF81234, string(x.PodInfraContainerID))
				}
			} else {
				r.EncodeString(codecSelferC_UTF81234, string("podInfraContainerID"))
				yym1518 := z.EncBinary()
				_ = yym1518
				if false {
				} else {
...
func (x *PodStatus) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj1521 := 0; ; yyj1521++ {
		...
		case "podInfraContainerID":
			if r.TryDecodeAsNil() {
				x.PodInfraContainerID = ""
			} else {
				x.PodInfraContainerID = string(r.DecodeString())
			}
		default:
...
func (x codecSelfer1234) decSlicePod(v *[]Pod, d *codec1978.Decoder) {
	...
	if yyv3559 == nil {
		if yyrl3559, yyrt3559 = z.DecInferLen(yyl3559, z.DecBasicHandle().MaxInitLen, 536); yyrt3559 {
			yyrr3559 = yyrl3559
		}
	...
	if yyl3559 == 0 {
		...
		if yyl3559 > cap(yyv3559) {
			yyrl3559, yyrt3559 = z.DecInferLen(yyl3559, z.DecBasicHandle().MaxInitLen, 536)
			yyv3559 = make([]Pod, yyrl3559)
			yyc3559 = true
