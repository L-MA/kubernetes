...
func (x codecSelfer1234) decSlicePod(v *[]Pod, d *codec1978.Decoder) {
	...
	if yyv3534 == nil {
		if yyrl3534, yyrt3534 = z.DecInferLen(yyl3534, z.DecBasicHandle().MaxInitLen, 512); yyrt3534 {
			yyrr3534 = yyrl3534
		}
	...
	if yyl3534 == 0 {
		...
		if yyl3534 > cap(yyv3534) {
			yyrl3534, yyrt3534 = z.DecInferLen(yyl3534, z.DecBasicHandle().MaxInitLen, 512)
			yyv3534 = make([]Pod, yyrl3534)
			yyc3534 = true
